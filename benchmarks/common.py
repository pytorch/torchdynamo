...
def recompile_profiler_experiment(
    args, model_iter_fn, optimize_ctx, model, example_inputs
):
...
def cold_start_experiment(args, model_iter_fn, optimize_ctx, model, example_inputs):
    compile_iters = 2
...
def speedup_experiment(args, model_iter_fn, optimize_ctx, model, example_inputs):
    """
...
def baselines(models, model_iter_fn, optimize_ctx, example_inputs, args):
    """
...
def speedup_experiment_ts(args, model_iter_fn, optimize_ctx, model, example_inputs):
    """
...
def speedup_experiment_sr(args, model_iter_fn, optimize_ctx, model, example_inputs):
    """
...
def speedup_experiment_onnx(args, model_iter_fn, optimize_ctx, model, example_inputs):
    """
...
def speedup_experiment_trt(args, model_iter_fn, optimize_ctx, model, example_inputs):
    """
...
def main(runner, original_dir=None):
    ...
    experiment = functools.partial(experiment, args, model_iter_fn, optimize_ctx)
