...
# This is a relatively unsafe flag for the sake of forcing cudagraphs despite
# us thinking there may be mutations. Discards input mutations.
force_cudagraphs = False
