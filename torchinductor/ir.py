    ...
    def map_args(self):
        ...
        args_dict = OrderedDict(
            [
                ...
                ("KERNEL_N", f"{V.graph.sizevars.size_hint(self.inputs[1].get_size()[0])}"),
                ("KERNEL_H", f"{V.graph.sizevars.size_hint(self.inputs[1].get_size()[2])}"),
                ("KERNEL_W", f"{V.graph.sizevars.size_hint(self.inputs[1].get_size()[3])}"),
