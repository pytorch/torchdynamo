...
from .conv_perf_model import import torch
import triton
import triton.language as tl
...
def conv(
    ...
    assert groups == 1, f"Do not support groups = {groups}"
    assert not transposed, "Do not support transposed"
