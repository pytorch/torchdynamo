...
register_pointwise(aten.acos)
register_pointwise(aten.asin)
register_pointwise(aten.asinh)
register_pointwise(aten.atan)
register_pointwise(aten.atanh)
register_pointwise(aten.ceil)
register_pointwise(aten.cos)
register_pointwise(aten.cosh)
register_pointwise(aten.erf)
register_pointwise(aten.erfc)
register_pointwise(aten.erfinv)
register_pointwise(aten.exp2)
register_pointwise(aten.expm1)
register_pointwise(aten.floor)
register_pointwise(aten.lgamma)
register_pointwise(aten.log10)
register_pointwise(aten.log1p)
register_pointwise(aten.log2)
register_pointwise(aten.round)
register_pointwise(aten.rsqrt)
register_pointwise(aten.sin)
register_pointwise(aten.sinh)
register_pointwise(aten.tan)
